...
```{r, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE}
attach('~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/human_chimp_AF_variant_calling_data_SNP_level.RData', warn.conflicts = FALSE)
