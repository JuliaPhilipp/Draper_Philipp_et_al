...
```{r summary table}
rbp_table_long_hc_AF <- summary_table(rnacmpt_ids, data_a_hc_AF_filtered, data_b_hc_AF_filtered, data_c_hc_AF_filtered, data_d_hc_AF_filtered, data_cons_hc_AF_filtered, data_spec_hc_AF_filtered, "human","chimp")
```
...
```{r summary table}
rbp_table_long_ho_AF <- summary_table(rnacmpt_ids, data_a_ho_AF_filtered, data_b_ho_AF_filtered, data_c_ho_AF_filtered, data_d_ho_AF_filtered, data_cons_ho_AF_filtered, data_spec_ho_AF_filtered, "human","orang")
```
...
```{r summary table}
rbp_table_long_hc_SE <- summary_table(rnacmpt_ids, data_a_hc_SE_filtered, data_b_hc_SE_filtered, data_c_hc_SE_filtered, data_d_hc_SE_filtered, data_cons_hc_SE_filtered, data_spec_hc_SE_filtered, "human","chimp")
```
...
```{r summary table}
rbp_table_long_ho_SE <- summary_table(rnacmpt_ids, data_a_ho_SE_filtered, data_b_ho_SE_filtered, data_c_ho_SE_filtered, data_d_ho_SE_filtered, data_cons_ho_SE_filtered, data_spec_ho_SE_filtered, "human","orang")
```
...
data_a_hc_AF_sig <- add_sig_level(data_a_hc_AF, rbp_table)
