---
title: "remap_variant_calling_SE_SNP_level"
author: "juphilip"
date: "6/26/2020"
...
load("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/ho_SE_AS_collapsed_new_mismatches.RData")
```
...
all_three_astc_in_one <- read.delim("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/astc_events/astc_in_at_least_one_species.txt", header = FALSE, stringsAsFactors = FALSE) %>% 
  filter(str_detect(V1, "SE"))

all_three_astc <- read.delim("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/astc_events/astc_in_all.txt", header = FALSE, stringsAsFactors = FALSE) %>% 
  filter(str_detect(V1, "SE"))
...
```{r load fastas}
human_strings <- readDNAStringSet("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/human_SE.fa", format = "fasta", use.names = T)

orang_strings <- readDNAStringSet("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/orang_SE.fa", format = "fasta", use.names = T)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_alignment_scores.png", width = 8, height = 6, units = "in", res = 300)
hist(unlist(SE_scores), breaks = 100, xlab = "Alignment score human/orang per SE event")
dev.off()

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_mismatches.png", width = 8, height = 6, units = "in", res= 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_boxplot_alignment_score_manhattandist_top100.png", width = 4, height = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_boxplot_nvariants_manhattandist_top100.png", width = 4, height = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/cor_SE_alignment_score_manhattan_dist.png", width = 4, height = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/cor_SE_num_variants_manhattan_dist.png", width = 4, height = 4, units = "in", res = 300)
...
save(pwm_output_h, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_human_pwms_out.RData")
save(pwm_output_o, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_orang_pwms_out.RData")
```
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_not_very_meaningful_overview.png", height = 5, width = 14, units = "in", res = 300)
...
write.table(collapsed_output_total_score, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/collapsed_output_total_score.tsv", row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_RBP_overview_by_dist_top100.png", height = 5, width = 20, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_RBP_overview_manhattan_dist_top100.png", height = 5, width = 15, units = "in", res = 300)
...
```{r binding scores}
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_total_scores.png", height = 4, width = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_total_scores_by_manhattan_top100.png", height = 5, width = 5, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_total_scores_by_manhattan_norm_top100.png", height = 5, width = 8, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_all_pwms.png", width = 10, height = 6, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_all_pwms_eventID_ranked.png", width = 15, height = 8, units = "in", res = 300)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_pwm_score_vs_manhattan_rank_by_eventID_top100.pdf", height = 8, width = 8)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_pwm_score_vs_manhattan_rank_top100.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_pwm_score_vs_manhattan_rank_zscore_version1.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_pwm_score_vs_manhattan_rank_zscore_version2_updated.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
write.table(all_normalized_z3, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/all_normalzed_z3.tsv", col.names = TRUE, row.names = FALSE, quote = FALSE, sep="\t")
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_pwm_score_vs_manhattan_rank_zscore_version3.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_score_distribution_conserved_species_sp.png", width = 5, height = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_summary_snvs.png", height = 6, width = 8, units = "in", res = 300)
ggplot(collapsed_mismatches, aes(x=snv)) +
  stat_count()
dev.off()

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_summary_snvs_by_manhattan.png", height = 6, width = 12, units = "in", res = 300)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/snv_density_dist_from_3ss.pdf", height = 4, width = 6)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/snv_density_dist_from_5ss.pdf", height = 4, width = 6)
...
ggplot(three_prime_df, aes(x=pos, color = event_id)) +
  ...
  facet_grid(cols = vars(cat))
```
do SNV/mismatch analysis for AS/ASTC and ASTC/ASTC separately
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_width_indels_top100.png", height = 6, width = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_width_indels_by_manhattan_top100.png", height = 6, width = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_width_indels_by_manhattan_norm_top_top100.png", height = 6, width = 2, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_width_indels_by_manhattan_norm_bottom_top100.png", height = 6, width = 2, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/location_mismatches.png", height = 4, width = 6, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS//pwm_output/SE_ecdf_all_cons_vs_spsp_top100.png", width = 6, height = 6, units = "in", res = 300)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS//pwm_output/SE_ecdf_per_rbp_top100.pdf")
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS//pwm_output/SE_ecdf_sig_notsig_vs_manhattan.png", height = 6, width = 6, units = "in", res = 300)
all_normalized_z %>% 
  filter(source == "human") %>% 
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS//pwm_output/SE_ecdf_per_rbp_sig_notsig.pdf")
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
  ks1 <- all_normalized_z %>% 
    filter(source == "human") %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS//pwm_output/SE_ecdf_sig_not_sig_vs_manhattan_basedonPWMscore.png", height = 6, width = 6, units = "in", res= 300)
all_normalized_z %>% 
  filter(source == "human") %>% 
  ggplot(aes(x=inner_dist, group = sig)) + 
  stat_ecdf(geom = "step", aes(color = sig), size = 1.3) +
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS//pwm_output/SE_ecdf_sig_not_sig_vs_manhattan_basedondeltaPWM.png", height = 6, width = 6, units = "in", res = 300)
all_normalized_z2 %>% 
  ggplot(aes(x=inner_dist, group = sig)) +
  stat_ecdf(geom = "step", aes(color = sig), size = 1.3) +
  theme(legend.title = element_blank(), legend.position = c(0.5,0.2)) +
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS//pwm_output/SE_ecdf_per_rbp_sig_notsig_basedondeltaPWM.pdf")
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
  ks1 <- all_normalized_z2 %>% 
    filter(sig == "sig") %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_test_boxplot_manhattan_z2.png", height = 5, width = 10, units = "in", res = 300)
all_normalized_z2 %>% 
    group_by(current_motif) %>% 
    filter(any(sig == "sig")) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/SE_test_boxplot_manhattan_z3.png", height = 5, width = 20, units = "in", res = 300)
all_normalized_z3 %>% 
    group_by(current_motif) %>% 
    filter(any(sig == "sig")) %>% 
    ggplot(aes(y=inner_dist, x=Gene.name, fill=sig)) +
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS//pwm_output/SE_all_pwms_normalized_zscore_thresholds.png", width = 10, height = 6, units = "in", res = 300)
all_normalized_z2 %>% 
  group_by(current_motif) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_all_pwms_normalized_zscore3_thresholds.png", width = 10, height = 6, units = "in", res = 300)
all_normalized_z3 %>% 
  group_by(current_motif) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_pwmscore_vs_manhattan.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z3 %>% 
  group_by(current_motif) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_ranked_zscore_vs_ranked_manhattan.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z3 %>%
  group_by(current_motif) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_zscore_vs_ranked_manhattan.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z3 %>%
  group_by(current_motif) %>% 
  mutate(rank_m = dplyr::dense_rank((-inner_dist))) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_zscore_vs_manhattan.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z3 %>%
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/SE_all_rbps_sig_vs_not_sig_zscore3.png", height = 5, width = 20, units = "in", res = 300)
all_normalized_z3 %>% 
    ggplot(aes(y=inner_dist, x=Gene.name, fill=sig)) +
    geom_boxplot(position=position_dodge(1)) + 
    ylab("Manhattan Distance") +
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/SE_all_rbps_sig_vs_not_sig_zscore3_filtered.png", height = 5, width = 20, units = "in", res = 300)
all_normalized_z3 %>% 
    group_by(current_motif) %>% 
    filter(any(sig == "sig")) %>% 
    ggplot(aes(y=inner_dist, x=Gene.name, fill=sig)) +
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/SE_all_rbps_sig_vs_not_sig_zscore3_wilcox_sig_001.png", height = 5, width = 20, units = "in", res = 300)
all_normalized_z3 %>% 
    group_by(current_motif) %>% 
    filter(any(sig == "sig")) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/SE_all_rbps_sig_vs_not_sig_zscore3_wilcox_sig_005.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z3 %>% 
    group_by(current_motif) %>% 
    filter(any(sig == "sig")) %>% 
    mutate(results = wilcox.test(inner_dist ~ sig)$p.value) %>% 
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS//SE_all_pwms_per_protein.pdf")
...
for (i in 1:length(which_proteins)){
  ...
  if (nrow(venn1) > 0){
    ...
    venn.diagram(list1, filename = paste0("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS//SE_all_pwms_for_",which_proteins[i],".png"), res = 300, imagetype = "png")
  }
}
...
for (i in 1:length(which_proteins)){
  ...
  if (nrow(venn1) > 0){
    ...
    if (length(list1) > 5){
      venn.diagram(list1[1:5], filename = paste0("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS//SE_all_pwms_all_snvs_for_",which_proteins[i],".png"), res = 300, imagetype = "png")
    } else{
      venn.diagram(list1, filename = paste0("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS//SE_all_pwms_all_snvs_for_",which_proteins[i],".png"), res = 300, imagetype = "png")
    }
...
```{r sig events}
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_sig_events_which_rbps_morehuman.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z2 %>% 
  filter(sig == "sig") %>% 
  filter(diff > 0) %>% 
  ungroup() %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_sig_events_top_20_pwms_morehuman.png", height = 5, width = 5, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_sig_events_top_20_pwms_morechimp.png", height = 5, width = 5, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_sig_events_which_rbps_morechimp.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z2 %>% 
  filter(sig == "sig") %>% 
  filter(diff < 0) %>% 
  ungroup() %>% 
...
write.table(output_table, "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_sig_table.txt", col.names = T, row.names = F, quote = F, sep = "\t")


output_table_sorted <- output_table %>% 
  arrange(desc(zscore))

write.table(output_table_sorted, "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_sig_table_sorted_zscore.txt", col.names = T, row.names = F, quote = F, sep = "\t")

write.table(unique(output_table_sorted$event_id), "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_event_ids.txt", col.names = F, row.names = F, quote = F, sep = "\t")
...
write.table(output_no_names, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE_AS/pwm_output/SE_sig_table_sorted_zscore_no_genename.tsv", quote = F, row.names = F, col.names = T, sep = "\t")
```
...
orang_gtf_plus_final <- orang_gtf_plus[seq(2, nrow(orang_gtf_plus), 3), ]

orang_gtf <- orang_gtf_plus_final
colnames(orang_gtf) <- c("chr","start","end","strand","event_id")
...
testing <- output_table %>% 
  ...
  mutate(event_link = paste0("http://public.gi.ucsc.edu/~juphilip/human_chimp_orang/remap_2020/variant_calling/human_orang/SE_candidates/",symbol,"_",event_id,"_sashimi_scatter.pdf")) %>% 
  mutate(variant_link = paste0("http://public.gi.ucsc.edu/~juphilip/human_chimp_orang/remap_2020/variant_calling/human_orang/SE_alignments/",variant,".pdf")) %>% 
  left_join(human_gtf, by = c("event_id")) %>% 
  left_join(orang_gtf, by = c("event_id")) %>% 
...
colnames(testing) <- c("event_id","manhattan_distance","deltaPWM_score","z_score","RBP","PWM","variant","coordinates_human","coordinates_orang")

write.table(testing, file = "~/Desktop/remap_human_orang_SE_AS_SNVs.tsv", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")
...
all_psi <- read.delim("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/pipeline_output/human_chimp_orang/all_species_junctioncounts.tsv")

filtered_psi <- all_psi %>% 
  filter(event_id %in% testing_more$event_id) %>% 
  #filter(species == "human" | species == "orangutan") %>% 
...
testing_more_with_psi <- testing_more %>% 
  ...
  mutate(event_id2 = str_replace(event_id, "\\|","%7c")) %>% 
  mutate(event_link = paste0("http://public.gi.ucsc.edu/~juphilip/human_chimp_orang/run12/variant_calling/SE_candidates/",symbol,"_",event_id2,"_sashimi_scatter.pdf")) %>% 
  left_join(human_gtf, by = c("event_id")) %>% 
  left_join(orang_gtf, by = c("event_id")) %>% 
  mutate(coordinates_h = paste0(chr.x,":",start.x,"-",end.x)) %>% 
...
write.table(testing_more_with_psi, file = "~/Desktop/remap_human_orang_SE_AS_SNVs_filtered_z2.tsv", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")
...
testing_more_with_psi_2 <- testing_more_2 %>% 
  ...
  #mutate(event_id2 = str_replace(event_id, "\\|","%7c")) %>% 
  mutate(event_link = paste0("http://public.gi.ucsc.edu/~juphilip/human_chimp_orang/run12/variant_calling/SE_candidates/",symbol,"_",event_id,"_sashimi_scatter.pdf")) %>% 
  left_join(human_gtf, by = c("event_id")) %>% 
  left_join(orang_gtf, by = c("event_id")) %>% 
  mutate(coordinates_h = paste0(chr.x,":",start.x,"-",end.x)) %>% 
  mutate(coordinates_o = paste0(chr.y,":",start.y,"-",end.y)) %>% 
...
write.table(testing_more_with_psi_2, file = "~/Desktop/remap_human_orang_SE_AS_SNVs_filtered_z1.tsv", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")
...
write.table(testing_more_with_psi_3, file = "~/Desktop/remap_human_orang_SE_AS_SNVs_filtered_z05.tsv", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")
...
testing <- output_table %>% 
  ...
  mutate(variant2 = str_replace(variant, "\\|", "%7c")) %>% 
  mutate(event_link = paste0("http://public.gi.ucsc.edu/~juphilip/human_chimp_orang/run12/variant_calling/SE_candidates/",symbol,"_",event_id2,"_sashimi_scatter.pdf")) %>% 
  mutate(variant_link = paste0("http://public.gi.ucsc.edu/~juphilip/human_chimp_orang/run12/variant_calling/SE_alignments/",variant2,".pdf")) %>% 
  left_join(human_gtf, by = c("event_id")) %>% 
...
write.table(all_events_new, file = "~/Desktop/remap_human_orang_SE_AS_snv_events_new.tsv", col.names = TRUE, row.names = FALSE, sep = "\t", quote = FALSE)
```
...
save(pwm_insertion_h, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_new_human_insertion_pwms_out.RData")
save(pwm_insertion_o, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_new_orang_insertion_pwms_out.RData")
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_insertions_not_very_meaningful_overview.png", height = 5, width = 14, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_insertions_RBP_overview_by_dist_top100.png", height = 5, width = 20, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_insertions_RBP_overview_manhattan_dist_top100.png", height = 5, width = 15, units = "in", res = 300)
...
save(pwm_deletion_h, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_new_human_deletion_pwms_out.RData")
save(pwm_deletion_o, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE//SE_new_orang_deletion_pwms_out.RData")
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_deletions_not_very_meaningful_overview.png", height = 5, width = 14, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_deletions_RBP_overview_by_dist_top100.png", height = 5, width = 20, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/SE_deletions_RBP_overview_manhattan_dist_top100.png", height = 5, width = 15, units = "in", res = 300)
...
```{r save data}
save.image("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_SE/human_orang_SE_variant_calling_data_SNP_level.RData")
