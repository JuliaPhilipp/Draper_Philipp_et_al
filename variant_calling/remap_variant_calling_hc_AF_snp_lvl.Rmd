---
title: "remap_variant_calling_hc_AF_snp_lvl"
author: "juphilip"
date: "11/13/2020"
...
load("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF_AS/hc_AF_AS_collapsed_new_mismatches.RData")
```

```{r human chimp AF orthologs}
...
```{r load fasta}
human_strings_upstream <- readDNAStringSet("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/human_upstream_AF.fa", format = "fasta", use.names = T)

human_strings_downstream <- readDNAStringSet("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/human_downstream_AF.fa", format = "fasta", use.names = T)

chimp_strings_upstream <- readDNAStringSet("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/chimp_upstream_AF.fa", format = "fasta", use.names = T)

chimp_strings_downstream <- readDNAStringSet("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/chimp_downstream_AF.fa", format = "fasta", use.names = T)
...
names(chimp_strings_upstream) <- str_replace(str_replace(names(chimp_strings_upstream), "\\(\\+\\)",""), "\\(\\-\\)", "")
names(chimp_strings_downstream) <- str_replace(str_replace(names(chimp_strings_downstream), "\\(\\+\\)",""), "\\(\\-\\)", "")

human_order_up <- match(tmp_names_up, names(human_strings_upstream))
chimp_order_up <- match(tmp_names_up, names(chimp_strings_upstream))

human_order_dn <- match(tmp_names_dn, names(human_strings_downstream))
chimp_order_dn <- match(tmp_names_dn, names(chimp_strings_downstream))



human_strings_up_ordered <- human_strings_upstream[human_order_up]
chimp_strings_up_ordered <- chimp_strings_upstream[chimp_order_up]

human_strings_dn_ordered <- human_strings_downstream[human_order_dn]
chimp_strings_dn_ordered <- chimp_strings_downstream[chimp_order_dn]

human_strings_ordered <- c(human_strings_up_ordered, human_strings_dn_ordered)
chimp_strings_ordered <- c(chimp_strings_up_ordered, chimp_strings_dn_ordered)

human_strings_up_ordered_iso <- human_strings_up_ordered
human_strings_dn_ordered_iso <- human_strings_dn_ordered

names(human_strings_up_ordered_iso) <- paste(names(human_strings_up_ordered),"_included",sep = "")
names(human_strings_dn_ordered_iso) <- paste(names(human_strings_dn_ordered), "_excluded", sep = "")

human_strings_ordered_iso <- c(human_strings_up_ordered_iso, human_strings_dn_ordered_iso)
...
for (i in 1:length(human_strings_ordered)){
  AF_alignments[[i]] <- pairwiseAlignment(human_strings_ordered[[i]], chimp_strings_ordered[[i]])
  AF_mismatches[[i]] <- mismatchTable(AF_alignments[[i]])
  AF_indels[[i]] <- indel(AF_alignments[[i]])
  AF_scores[[i]] <- score(AF_alignments[[i]])
}

names(AF_scores) <- names(human_strings_ordered_iso)
names(AF_mismatches) <- names(human_strings_ordered_iso)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_alignment_scores.png", width = 8, height = 6, units = "in", res = 300)
histinfo <- hist(unlist(AF_scores), breaks = 100, xlab = "Alignment score human/chimp per AF event")
dev.off()

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF//AF_mismatches.png", width = 8, height = 6, units = "in", res= 300)
hist(unlist(lapply(AF_mismatches, FUN=nrow)), breaks = 75, xlab = "Number of mismatches between human/chimp per AF event")
dev.off()
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_boxplot_alignment_score_manhattandist_top100.png", width = 4, height = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF//AF_boxplot_nvariants_manhattandist_top100.png", width = 4, height = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/cor_AF_alignment_score_manhattan_dist.png", width = 4, height = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/cor_AF_alignment_score_manhattan_dist_log10.png", width = 4, height = 4, units = "in", res = 300)
ggplot(AF_score_frame, aes(x=score, y=manhattan_dist)) +
  geom_point() +
  geom_smooth(method = "lm", formula = y~x) +
  stat_poly_eq(formula = y~x, 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/cor_AF_num_variants_manhattan_dist.png", width = 4, height = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/cor_AF_num_variants_manhattan_dist_log.png", width = 4, height = 4, units = "in", res = 300)
ggplot(AF_score_frame, aes(x=n_variants, y=manhattan_dist)) +
  geom_point() +
  geom_smooth(method = "lm", formula = y~x) +
  stat_poly_eq(formula = y~x, 
...
for (i in 1:length(human_strings_dn_ordered)){
 test_data[[i]]<-alphabetFrequency(chimp_strings_dn_ordered[[i]])
}
...
test_data <- list()
for (i in 1:length(chimp_strings_dn_ordered)){
 test_data[[i]]<-alphabetFrequency(chimp_strings_dn_ordered[[i]])
}

test_frame_c <- as.data.frame(do.call("rbind", test_data))
rownames(test_frame_c) <- names(chimp_strings_dn_ordered)
...
for (i in 1:length(AF_mismatches)){
  ...
  pwm_output_c[[i]] <- tmp_output_c
}

names(pwm_output_h) <- names(human_strings_ordered_iso)
names(pwm_output_c) <- names(human_strings_ordered_iso)

save(pwm_output_h, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_new_human_pwms_out.RData")
save(pwm_output_c, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_new_chimp_pwms_out.RData")
```
...
for (i in 1:length(AF_mismatches)){
  ...
  if (nrow(AF_mismatches[[i]]) > 0){
    for (k in 1:nrow(AF_mismatches[[i]])){
      ...
      tmp_output_snp[[k]] <- data.frame(snp_id = current_snp, pos_h = pos_mismatch_h, pos_o = pos_mismatch_c, seq_h = pattern_h, seq_c = pattern_c)
    }
  }
...
new_pwm_output_c <- list()
for (i in 1:length(pwm_output_h)){
  new_pwm_output_h[[i]] <- do.call(rbind, pwm_output_h[[i]]) 
  new_pwm_output_c[[i]] <- do.call(rbind, pwm_output_c[[i]]) 
}

names(new_pwm_output_c) <- names(human_strings_ordered_iso)[1:length(new_pwm_output_c)]
names(new_pwm_output_h) <- names(human_strings_ordered_iso)[1:length(new_pwm_output_h)]
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_not_very_meaningful_overview.png", height = 5, width = 14, units = "in", res = 300)
...
write.table(collapsed_output_total_score, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/collapsed_output_total_score.tsv", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_RBP_overview_by_dist_top100.png", height = 5, width = 20, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_RBP_overview_manhattan_dist_top100.png", height = 5, width = 15, units = "in", res = 300)
...
```{r save prelim data}
save.image(file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/hc_AF_ASTC_snp_lvl_prelim.RData")
```

```{r binding scores}
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_total_scores.png", height = 4, width = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_total_scores_by_manhattan_top100.png", height = 5, width = 5, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF//AF_total_scores_by_manhattan_norm_top100.png", height = 5, width = 8, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_all_pwms.png", width = 10, height = 6, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_all_pwms_eventID_ranked.png", width = 15, height = 8, units = "in", res = 300)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_pwm_score_vs_manhattan_rank_by_eventID_top100.pdf", height = 8, width = 8)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_pwm_score_vs_manhattan_rank_top100.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_pwm_score_vs_manhattan_rank_zscore_version1.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_pwm_score_vs_manhattan_rank_zscore_version2_updated.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
write.table(all_normalized_z3, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/all_normalized_z3.tsv", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_pwm_score_vs_manhattan_rank_zscore_version3.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/distribution_delta_scores_cons_vs_spec.png", height = 5, width = 5, units = "in", res = 300)
...
names(new_mismatches) <- names(AF_mismatches)[1:length(new_mismatches)]
...
hc_AF_ASTC_collapsed_new_mismatches <- collapsed_new_mismatches

save(hc_AF_ASTC_collapsed_new_mismatches, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/hc_AF_ASTC_collapsed_new_mismatches.RData")

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_summary_snvs.png", height = 6, width = 8, units = "in", res = 300)
ggplot(collapsed_mismatches, aes(x=snv)) +
  stat_count()
dev.off()

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_summary_snvs_by_manhattan.png", height = 6, width = 12, units = "in", res = 300)
ggplot(collapsed_new_mismatches, aes(x=snv))+
  stat_count() +
  facet_grid(cols = vars(cat))
dev.off()

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF//AF_snvs_cons_vs_specific_top100.png", height = 4, width = 6, units = "in", res = 300)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF//AF_snvs_cons_vs_specific_top100.pdf", height = 4, width = 6)
ggplot(subset(collapsed_new_mismatches, cat == "top" | cat == "bottom"), aes(x=snv)) +
  stat_count(aes(group = cat, fill = cat), position = "dodge") + 
  scale_fill_manual(values = c("blue","gold"), labels = c("conserved", "species-specific")) +
...
m2 <- data.frame(table(subset(collapsed_new_mismatches, cat == "bottom")$snv)/sum(width(bottom_human_strings))) %>% 
  mutate(cat = "bottom")
m3 <- data.frame(table(hc_AF_AS_collapsed_new_mismatches$snv)/sum(width(human_AF_AS_strings_ordered_iso))) %>%  mutate(cat = "AS")
m4 <- rbind(m1,m2,m3)


pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_snvs_cons_vs_specific_normalized_human_top100_with_AS.pdf", height = 4, width = 8)
...
m2 <- data.frame(sum = sum(table(subset(collapsed_new_mismatches, cat == "bottom")$snv))/sum(width(bottom_human_strings))) %>% 
  mutate(cat = "bottom")
m3 <- data.frame(sum = sum(table(hc_AF_AS_collapsed_new_mismatches$snv))/sum(width(human_AF_AS_strings_ordered_iso))) %>% 
  mutate(cat = "AS")
m4 <- rbind(m1,m2,m3)


pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_snvs_cons_vs_specific_normalized_human_top100_sum_with_AS.pdf", height = 4, width = 6)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_snvs_cons_vs_specific_normalized_chimp_top100.png", height = 4, width = 8, units = "in", res = 300)
...
five_prime_df <- collapsed_new_mismatches %>% 
  rbind((hc_AF_AS_collapsed_new_mismatches %>% mutate(cat = "AS"))) %>% 
...
hc_AF_AS_collapsed_new_mismatches_sub <- hc_AF_AS_collapsed_new_mismatches %>% 
  mutate(event_id = paste(event_id,iso,sep="_")) %>% 
  filter(event_id %in% names(AS_string_sub))

five_prime_df_norm <- collapsed_new_mismatches %>% 
  mutate(event_id = paste(event_id,iso, sep = "_")) %>% 
  rbind((hc_AF_AS_collapsed_new_mismatches_sub %>% mutate(cat = "AS"))) %>% 
  mutate(PatternStart = as.numeric(PatternStart)) %>% 
  filter(cat == "top" | cat == "bottom" | cat == "AS") %>% 
  filter(PatternStart < 250)

# this would be relative to TTS
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/snv_density_dist_from_TSS.pdf", height = 4, width = 6)
...
exon_length <- data.frame(len = c(nchar(human_strings_ordered), nchar(human_AF_AS_strings_ordered_iso)), event_id = c(names(human_strings_ordered_iso), names(human_AF_AS_strings_ordered_iso)))
...
exon_length_norm <- data.frame(len = c(nchar(human_strings_ordered), nchar(AS_string_sub)), event_id = c(names(human_strings_ordered_iso), names(AS_string_sub)))
...
##
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/snv_density_dist_from_5SS.pdf", height = 4, width = 6)
...
names(AF_in_list) <- names(human_strings_ordered_iso)
names(AF_del_list) <- names(human_strings_ordered_iso)
...
names(AF_in_list_new) <- names(human_strings_ordered_iso)[1:length(AF_in_list_new)]
names(AF_del_list_new) <- names(human_strings_ordered_iso)[1:length(AF_in_list_new)]
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_width_indels_top100.png", height = 6, width = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_width_indels_by_manhattan_top100.png", height = 6, width = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_width_indels_by_manhattan_norm_top_top100.png", height = 6, width = 2, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_width_indels_by_manhattan_norm_bottom_top100.png", height = 6, width = 2, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_ecdf_all_cons_vs_spsp_top100.png", width = 6, height = 6, units = "in", res = 300)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/ecdf_per_rbp_top100.pdf")
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
  ks1 <-  all_test_rank_per_pwm %>% 
    left_join(categorized_all_AF, by = "event_id") %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_ecdf_proximal_vs_distal.png", width = 6, height = 6, units = "in", res = 300)
all_test_rank_per_pwm %>% 
    left_join(categorized_all_AF, by = "event_id") %>% 
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_ecdf_per_rbp_proximal_vs_distal.pdf")
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
  ks1 <-  all_test_rank_per_pwm %>% 
    left_join(categorized_all_AF, by = "event_id") %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_ecdf_sig_notsig_vs_manhattan.png", height = 6, width = 6, units = "in", res = 300)
all_normalized_z %>% 
  filter(source == "human") %>% 
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_ecdf_per_rbp_sig_notsig.pdf")
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
  ks1 <- all_normalized_z %>% 
    filter(source == "human") %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_ecdf_sig_not_sig_vs_manhattan_basedonPWMscore.png", height = 6, width = 6, units = "in", res= 300)
all_normalized_z %>% 
  filter(source == "human") %>% 
  ggplot(aes(x=manhattan_dist, group = sig)) + 
  stat_ecdf(geom = "step", aes(color = sig), size = 1.3) +
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_ecdf_sig_not_sig_vs_manhattan_basedondeltaPWM.png", height = 6, width = 6, units = "in", res = 300)
all_normalized_z2 %>% 
  ggplot(aes(x=manhattan_dist, group = sig)) +
  stat_ecdf(geom = "step", aes(color = sig), size = 1.3) +
  theme(legend.title = element_blank(), legend.position = c(0.5,0.2)) +
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_ecdf_per_rbp_sig_notsig_basedondeltaPWM.pdf")
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
  ks1 <- all_normalized_z2 %>% 
    filter(sig == "sig") %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF//AF_all_rbps_sig_vs_not_sig.png", height = 5, width = 20, units = "in", res = 300)
all_normalized_z2 %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF//pwm_output/AF_all_pwms_normalized_zscore_thresholds.png", width = 10, height = 6, units = "in", res = 300)
all_normalized_z2 %>% 
  group_by(current_motif) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_all_pwms_normalized_zscore3_thresholds.png", width = 10, height = 6, units = "in", res = 300)
all_normalized_z3 %>% 
  group_by(current_motif) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_pwmscore_vs_manhattan.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z3 %>% 
  group_by(current_motif) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_zscore_vs_ranked_manhattan.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z3 %>%
  group_by(current_motif) %>% 
  mutate(rank = dplyr::dense_rank((-manhattan_dist))) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_zscore_vs_manhattan.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z3 %>%
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_all_rbps_sig_vs_not_sig_zscore3.png", height = 5, width = 20, units = "in", res = 300)
all_normalized_z3 %>% 
    ggplot(aes(y=manhattan_dist, x=Gene.name, fill=sig)) +
    geom_boxplot(position=position_dodge(1)) + 
    ylab("Manhattan Distance") +
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_all_rbps_sig_vs_not_sig_zscore3_filtered.png", height = 5, width = 20, units = "in", res = 300)
all_normalized_z3 %>% 
    group_by(current_motif) %>% 
    filter(any(sig == "sig")) %>% 
    ggplot(aes(y=manhattan_dist, x=Gene.name, fill=sig)) +
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_all_rbps_sig_vs_not_sig_zscore3_wilcox_sig_001.png", height = 5, width = 20, units = "in", res = 300)
all_normalized_z3 %>% 
    group_by(current_motif) %>% 
    filter(any(sig == "sig")) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_all_rbps_sig_vs_not_sig_zscore3_wilcox_sig_005.png", height = 5, width = 10, units = "in", res = 300)
all_normalized_z3 %>% 
    group_by(current_motif) %>% 
    filter(any(sig == "sig")) %>% 
    mutate(results = wilcox.test(manhattan_dist ~ sig)$p.value) %>% 
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_all_pwms_per_protein.pdf")
...
for (i in 1:length(which_proteins)){
  ...
  if (nrow(venn1) > 0){
    ...
    venn.diagram(list1, filename = paste0("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_all_pwms_for_",which_proteins[i],".png"), res = 300, imagetype = "png")
  }
}
...
for (i in 11:length(which_proteins)){
  ...
  if (nrow(venn1) > 0){
    ...
    venn.diagram(list1, filename = paste0("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_all_pwms_all_snvs_for_",which_proteins[i],".png"), res = 300, imagetype = "png")
  }
}
...
```{r sig events}
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_sig_events_which_rbps_morehuman.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z2 %>% 
  filter(sig == "sig") %>% 
  filter(diff > 0) %>% 
  ungroup() %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_sig_events_top_20_pwms_morehuman.png", height = 5, width = 5, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_sig_events_top_20_pwms_morechimp.png", height = 5, width = 5, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_sig_events_which_rbps_morechimp.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z2 %>% 
  filter(sig == "sig") %>% 
  filter(diff < 0) %>% 
  ungroup() %>% 
...
all_events <- read.delim("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/pipeline_output/human_chimp_orang/human_genes_events.tsv") %>% 
  na.omit() %>% 
  unique()
...
write.table(output_table, "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_sig_table.txt", col.names = T, row.names = F, quote = F, sep = "\t")


output_table_sorted <- output_table %>% 
  arrange(desc(zscore))

write.table(output_table_sorted, "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_sig_table_sorted_zscore.txt", col.names = T, row.names = F, quote = F, sep = "\t")

write.table(unique(output_table_sorted$event_id), "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/event_ids.txt", col.names = F, row.names = F, quote = F, sep = "\t")
...
write.table(output_no_names, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/pwm_output/AF_sig_table_sorted_zscore_no_genename.tsv", row.names = F, col.names = T, sep = "\t", quote = F)
```
...
for (i in 1:length(AF_in_list_new_new)){
  ...
  pwm_insertion_c[[i]] <- tmp_output_c
}

names(pwm_insertion_h) <- names(human_strings_ordered_iso)[1:length(pwm_insertion_h)]
names(pwm_insertion_c) <- names(human_strings_ordered_iso)[1:length(pwm_insertion_c)]

save(pwm_insertion_h, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_new_human_insertion_pwms_out.RData")
save(pwm_insertion_c, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_new_chimp_insertion_pwms_out.RData")
...
for (i in 1:length(AF_in_list_new_new)){
  ...
  if (!is.null(nrow(AF_in_list_new_new[[i]]))){
    for (k in 1:nrow(AF_in_list_new_new[[i]])){
      ...
      if ( AF_in_list_new_new[[i]]$width[k] > 1 ){
        ...
        # for human the approach stays the same
        pos_deletion_c <- AF_in_list_new_new[[i]]$start[k]
        # for chimp, position equivalent is one earlier
        ...
        current_motif <- names(pwms_list)[j]
        current_pwm <- pwms_list[[j]]
        string_start_c <- pos_deletion_c - ncol(pwms_list[[j]])
        string_end_c <- pos_deletion_c + ncol(pwms_list[[j]])
        if (string_start_c < 1){
          string_start_c <- 1
        }
  ...
  pwm_deletion_c[[i]] <- tmp_output_c
}

names(pwm_deletion_h) <- names(human_strings_ordered_iso)[1:length(pwm_deletion_h)]
names(pwm_deletion_c) <- names(human_strings_ordered_iso)[1:length(pwm_deletion_c)]

save(pwm_deletion_h, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_new_human_deletion_pwms_out.RData")
save(pwm_deletion_c, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/AF_new_chimp_deletion_pwms_out.RData")

```

```{r, eval=FALSE}
save.image("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_AF/human_chimp_AF_variant_calling_data_SNP_level.RData")
```
