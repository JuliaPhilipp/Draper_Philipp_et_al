---
title: "remap_variant_calling_ho_AF_AS_snp_lvl"
author: "juphilip"
date: "10/30/2020"
...
#write.table(human_orang_as, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/as_events/as_both_ho_AF.txt", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
```

```{r load fasta}
human_strings_upstream <- readDNAStringSet("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/human_upstream_AF.fa", format = "fasta", use.names = T)

human_strings_downstream <- readDNAStringSet("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/human_downstream_AF.fa", format = "fasta", use.names = T)

orang_strings_upstream <- readDNAStringSet("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/orang_upstream_AF.fa", format = "fasta", use.names = T)

orang_strings_downstream <- readDNAStringSet("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/orang_downstream_AF.fa", format = "fasta", use.names = T)
...
using manhattan distance and top sets doesn't make too much sense in the AS group
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_alignment_scores.png", width = 8, height = 6, units = "in", res = 300)
histinfo <- hist(unlist(AF_scores), breaks = 100, xlab = "Alignment score human/orang per AF event")
dev.off()

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_mismatches.png", width = 8, height = 6, units = "in", res= 300)
...
rownames(test_frame_c) <- names(orang_strings_dn_ordered)
...
save(pwm_output_h, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_AS_new_human_pwms_out.RData")
save(pwm_output_o, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_AS_new_orang_pwms_out.RData")
```
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_not_very_meaningful_overview.png", height = 5, width = 14, units = "in", res = 300)
...
collapsed_output_total_score <- collapsed_output_total %>%
  mutate(iso = case_when(str_detect(current_snp,"included") ~ "included",
                         str_detect(current_snp,"excluded") ~ "excluded")) %>% 
  left_join(categorized_all_AF, by = "event_id") %>% 
  filter(!is.na(manhattan_dist))

write.table(collapsed_output_total_score, "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/collapsed_output_total_score.tsv", row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_RBP_overview_by_dist_top100.png", height = 5, width = 20, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_RBP_overview_manhattan_dist_top100.png", height = 5, width = 15, units = "in", res = 300)
...
```{r binding scores}
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_total_scores.png", height = 4, width = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_total_scores_by_manhattan_top100.png", height = 5, width = 5, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_total_scores_by_manhattan_norm_top100.png", height = 5, width = 8, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_all_pwms.png", width = 10, height = 6, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_all_pwms_eventID_ranked.png", width = 15, height = 8, units = "in", res = 300)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_pwm_score_vs_manhattan_rank_by_eventID_top100.pdf", height = 8, width = 8)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_pwm_score_vs_manhattan_rank_top100.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_pwm_score_vs_manhattan_rank_zscore_version1.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_pwm_score_vs_manhattan_rank_zscore_version2_updated.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
write.table(all_normalized_z3, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/all_normalized_z3.tsv", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_pwm_score_vs_manhattan_rank_zscore_version3.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/distribution_delta_scores_cons_vs_spec.png", height = 5, width = 5, units = "in", res = 300)
...
ho_AF_AS_collapsed_new_mismatches <- collapsed_new_mismatches
human_AF_AS_strings_ordered_iso <- human_strings_ordered_iso

save(ho_AF_AS_collapsed_new_mismatches, human_AF_AS_strings_ordered_iso, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/ho_AF_AS_collapsed_new_mismatches.RData")

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_summary_snvs.png", height = 6, width = 8, units = "in", res = 300)
ggplot(collapsed_mismatches, aes(x=snv)) +
  stat_count()
dev.off()

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_summary_snvs_by_manhattan.png", height = 6, width = 12, units = "in", res = 300)
ggplot(collapsed_new_mismatches, aes(x=snv))+
  stat_count() +
  facet_grid(cols = vars(cat))
dev.off()

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS//AF_snvs_cons_vs_specific_top100.png", height = 4, width = 6, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_snvs_cons_vs_specific_normalized_human_top100.png", height = 4, width = 8, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_snvs_cons_vs_specific_normalized_orang_top100.png", height = 4, width = 8, units = "in", res = 300)
ggplot(m3, aes(x=Var1, y=Freq, group=cat)) +
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_width_indels_top100.png", height = 6, width = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_width_indels_by_manhattan_top100.png", height = 6, width = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_width_indels_by_manhattan_norm_top_top100.png", height = 6, width = 2, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_width_indels_by_manhattan_norm_bottom_top100.png", height = 6, width = 2, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_ecdf_all_cons_vs_spsp_top100.png", width = 6, height = 6, units = "in", res = 300)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/ecdf_per_rbp_top100.pdf")
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
  ks1 <-  all_test_rank_per_pwm %>% 
    left_join(categorized_all_AF, by = "event_id") %>% 
...
dev.off()
```
include if statement for k test if no result so the loop doesn't break
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_ecdf_proximal_vs_distal.png", width = 6, height = 6, units = "in", res = 300)
all_test_rank_per_pwm %>% 
    left_join(categorized_all_AF, by = "event_id") %>% 
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_ecdf_per_rbp_proximal_vs_distal.pdf")
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
  ks1 <-  all_test_rank_per_pwm %>% 
    left_join(categorized_all_AF, by = "event_id") %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_ecdf_sig_notsig_vs_manhattan.png", height = 6, width = 6, units = "in", res = 300)
all_normalized_z %>% 
  filter(source == "human") %>% 
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_ecdf_per_rbp_sig_notsig.pdf")
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
  ks1 <- all_normalized_z %>% 
    filter(source == "human") %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_ecdf_sig_not_sig_vs_manhattan_basedonPWMscore.png", height = 6, width = 6, units = "in", res= 300)
all_normalized_z %>% 
  filter(source == "human") %>% 
  ggplot(aes(x=manhattan_dist, group = sig)) + 
  stat_ecdf(geom = "step", aes(color = sig), size = 1.3) +
  theme(legend.title = element_blank(), legend.position = c(0.5,0.2)) +
  ylab("Cumulative Fraction") +
  annotate("text", label = paste("p-value 0.8689"), x=Inf , y=0, hjust=2, vjust=0) +
  xlab("Manhattan Distance")
dev.off()
```
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_ecdf_sig_not_sig_vs_manhattan_basedondeltaPWM.png", height = 6, width = 6, units = "in", res = 300)
all_normalized_z2 %>% 
  ggplot(aes(x=manhattan_dist, group = sig)) +
  stat_ecdf(geom = "step", aes(color = sig), size = 1.3) +
  theme(legend.title = element_blank(), legend.position = c(0.5,0.2)) +
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_ecdf_per_rbp_sig_notsig_basedondeltaPWM.pdf")
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
  ks1 <- all_normalized_z2 %>% 
    filter(sig == "sig") %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS//AF_all_rbps_sig_vs_not_sig.png", height = 5, width = 20, units = "in", res = 300)
all_normalized_z2 %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS//pwm_output/AF_all_pwms_normalized_zscore_thresholds.png", width = 10, height = 6, units = "in", res = 300)
all_normalized_z2 %>% 
  group_by(current_motif) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_all_pwms_normalized_zscore3_thresholds.png", width = 10, height = 6, units = "in", res = 300)
all_normalized_z3 %>% 
  group_by(current_motif) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_pwmscore_vs_manhattan.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z3 %>% 
  group_by(current_motif) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_zscore_vs_ranked_manhattan.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z3 %>%
  group_by(current_motif) %>% 
  mutate(rank = dplyr::dense_rank((-manhattan_dist))) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_zscore_vs_manhattan.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z3 %>%
...
ggplot(aes(x=rank_z, y=rank_m)) +
  ...
  theme(legend.title = element_blank(), legend.position = c(0.85, 0.9))
```
wilcox test problems?
```{r boxplot for zscore 3}
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_all_rbps_sig_vs_not_sig_zscore3.png", height = 5, width = 20, units = "in", res = 300)
all_normalized_z3 %>% 
    ggplot(aes(y=manhattan_dist, x=Gene.name, fill=sig)) +
    geom_boxplot(position=position_dodge(1)) + 
    ylab("Manhattan Distance") +
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_all_rbps_sig_vs_not_sig_zscore3_filtered.png", height = 5, width = 20, units = "in", res = 300)
all_normalized_z3 %>% 
    group_by(current_motif) %>% 
    filter(any(sig == "sig")) %>% 
    ggplot(aes(y=manhattan_dist, x=Gene.name, fill=sig)) +
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_all_rbps_sig_vs_not_sig_zscore3_wilcox_sig_001.png", height = 5, width = 20, units = "in", res = 300)
all_normalized_z3 %>% 
    group_by(current_motif) %>% 
    filter(any(sig == "sig")) %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_all_rbps_sig_vs_not_sig_zscore3_wilcox_sig_005.png", height = 5, width = 10, units = "in", res = 300)
all_normalized_z3 %>% 
    group_by(current_motif) %>% 
    filter(any(sig == "sig")) %>% 
    mutate(results = wilcox.test(manhattan_dist ~ sig)$p.value) %>% 
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_all_pwms_per_protein.pdf")
...
for (i in 1:length(which_proteins)){
  ...
  if (nrow(venn1) > 0){
    ...
    venn.diagram(list1, filename = paste0("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_all_pwms_for_",which_proteins[i],".png"), res = 300, imagetype = "png")
  }
}
...
for (i in 11:length(which_proteins)){
  ...
  if (nrow(venn1) > 0){
    ...
    venn.diagram(list1, filename = paste0("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_all_pwms_all_snvs_for_",which_proteins[i],".png"), res = 300, imagetype = "png")
  }
}
...
```{r sig events}
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_sig_events_which_rbps_morehuman.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z2 %>% 
  filter(sig == "sig") %>% 
  filter(diff > 0) %>% 
  ungroup() %>% 
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_sig_events_top_20_pwms_morehuman.png", height = 5, width = 5, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_sig_events_top_20_pwms_moreorang.png", height = 5, width = 5, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_sig_events_which_rbps_moreorang.png", height = 5, width = 5, units = "in", res = 300)
all_normalized_z2 %>% 
  filter(sig == "sig") %>% 
  filter(diff < 0) %>% 
  ungroup() %>% 
...
write.table(output_table, "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_sig_table.txt", col.names = T, row.names = F, quote = F, sep = "\t")


output_table_sorted <- output_table %>% 
  arrange(desc(zscore))

write.table(output_table_sorted, "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_sig_table_sorted_zscore.txt", col.names = T, row.names = F, quote = F, sep = "\t")

write.table(unique(output_table_sorted$event_id), "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/event_ids.txt", col.names = F, row.names = F, quote = F, sep = "\t")
...
write.table(output_no_names, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/pwm_output/AF_sig_table_sorted_zscore_no_genename.tsv", row.names = F, col.names = T, sep = "\t", quote = F)
```
...
## INSERTIONS
this problem can be solved by using the pattern(AF_alignments[[i]]) and subject(AF_alignments[[i]]) and getting the start and end as usual, except for not making it shorter to fit the human string but to fit the alignment pattern, then i'll get the correct sequence
if it is a insertion, the seq will be in pattern (human) and if its a deltion the sequence will be in subject(orang)
  ...
  if (!is.null(nrow(AF_in_list_new_new[[i]]))){
    for (k in 1:nrow(AF_in_list_new_new[[i]])){
      ...
      if ( AF_in_list_new_new[[i]]$width[k] > 1 ){
        ...
        # pwm match
        #query_string_h <- human_strings_ordered[[i]][string_start_h:string_end_h]
        query_string_h <- substr(as.character(pattern(AF_alignments[[i]])),
                                 string_start_h,string_end_h)
        query_string_c <- orang_strings_ordered[[i]][string_start_c:string_end_c]
        query_string_c <- substr(as.character(subject(AF_alignments[[i]])),
                                 string_start_c, string_end_c)
...
names(pwm_insertion_o) <- names(human_strings_ordered_iso)[1:length(pwm_insertion_o)]

save(pwm_insertion_h, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_new_human_insertion_pwms_out.RData")
save(pwm_insertion_o, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_new_orang_insertion_pwms_out.RData")
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_insertions_not_very_meaningful_overview.png", height = 5, width = 14, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_insertions_RBP_overview_by_dist_top100.png", height = 5, width = 20, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_insertions_RBP_overview_manhattan_dist_top100.png", height = 5, width = 15, units = "in", res = 300)
...
# loop
for (i in 1:length(AF_del_list_new_new)){
  current_event <- names(AF_del_list_new_new)[i]
  # if any mismatches are reported, loop through them
  tmp_output_h <- list()
  tmp_output_c <- list()
  if (!is.null(nrow(AF_del_list_new_new[[i]]))){
    for (k in 1:nrow(AF_del_list_new_new[[i]])){
      # position mismatch for human
      tmp_tmp_output_h <- list()
      tmp_tmp_output_c <- list()
      if ( AF_del_list_new_new[[i]]$width[k] > 1 ){
        # put those in a different list for later
        long_deletions[[length(long_deletions)+1]] <- AF_del_list_new_new[[i]][k,]
      } else{
        # here's what to do with the 1nt deletions
        # for human the approach stays the same
        pos_deletion_o <- AF_del_list_new_new[[i]]$start[k]
        # for orang, position equivalent is one earlier
...
names(pwm_deletion_o) <- names(human_strings_ordered_iso)[1:length(pwm_deletion_o)]

save(pwm_deletion_h, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_new_human_deletion_pwms_out.RData")
save(pwm_deletion_o, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_new_orang_deletion_pwms_out.RData")
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_deletions_not_very_meaningful_overview.png", height = 5, width = 14, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_deletions_RBP_overview_by_dist_top100.png", height = 5, width = 20, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/AF_deletions_RBP_overview_manhattan_dist_top100.png", height = 5, width = 15, units = "in", res = 300)
...
```{r save data}
save.image("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_orang_AF_AS/human_orang_AF_AS_variant_calling_data_SNP_level.RData")
```