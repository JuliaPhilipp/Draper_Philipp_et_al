---
title: "remap_variant_calling_hc_SE_AS_snp_lvl"
author: "juphilip"
date: "11/11/2020"
...
human_chimp_as <- human_as %>% 
  filter(V1 %in% chimp_as$V1)

```

#FASTA
```{r load fastas}
human_strings <- readDNAStringSet("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/human_SE_AS.fa", format = "fasta", use.names = T)

chimp_strings <- readDNAStringSet("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/chimp_SE_AS.fa", format = "fasta", use.names = T)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_alignment_scores.png", width = 8, height = 6, units = "in", res = 300)
hist(unlist(SE_scores), breaks = 100, xlab = "Alignment score human/chimp per SE event")
dev.off()

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_mismatches.png", width = 8, height = 6, units = "in", res= 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_boxplot_alignment_score_manhattandist_top100.png", width = 4, height = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_boxplot_nvariants_manhattandist_top100.png", width = 4, height = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/cor_SE_alignment_score_manhattan_dist.png", width = 4, height = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/cor_SE_num_variants_manhattan_dist.png", width = 4, height = 4, units = "in", res = 300)
...
save(pwm_output_h, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_AS_human_pwms_out.RData")
save(pwm_output_o, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_AS_chimp_pwms_out.RData")
```
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_not_very_meaningful_overview.png", height = 5, width = 14, units = "in", res = 300)
...
write.table(collapsed_output_total_score, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/collapsed_output_total_score.tsv", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")

write.table(collapsed_output_total, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/collapsed_output_total.tsv", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_RBP_overview_by_dist_top100.png", height = 5, width = 20, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_RBP_overview_manhattan_dist_top100.png", height = 5, width = 15, units = "in", res = 300)
...
```{r binding scores}
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_total_scores.png", height = 4, width = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_total_scores_by_manhattan_top100.png", height = 5, width = 5, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_total_scores_by_manhattan_norm_top100.png", height = 5, width = 8, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_all_pwms.png", width = 10, height = 6, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_all_pwms_eventID_ranked.png", width = 15, height = 8, units = "in", res = 300)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_pwm_score_vs_manhattan_rank_by_eventID_top100.pdf", height = 8, width = 8)
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_pwm_score_vs_manhattan_rank_top100.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_pwm_score_vs_manhattan_rank_zscore_version1.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_pwm_score_vs_manhattan_rank_zscore_version2_updated.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
write.table(all_normalized_z3, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/all_normalized_z3.tsv", col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")
...
pdf("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_pwm_score_vs_manhattan_rank_zscore_version3.pdf", height = 8, width = 8)
for (i in 1:length(all_rbps)){
  rbp_name <- rnacmpt_ids[which(rnacmpt_ids$current_motif == all_rbps[i]),"Gene.name"]
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_score_distribution_conserved_species_sp.png", width = 5, height = 4, units = "in", res = 300)
...
hc_SE_AS_collapsed_new_mismatches <- collapsed_new_mismatches
human_SE_AS_strings_ordered_iso <- human_strings_ordered

save(hc_SE_AS_collapsed_new_mismatches, human_SE_AS_strings_ordered_iso, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/hc_SE_AS_collapsed_new_mismatches.RData")

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_summary_snvs.png", height = 6, width = 8, units = "in", res = 300)
ggplot(collapsed_mismatches, aes(x=snv)) +
  stat_count()
dev.off()

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_summary_snvs_by_manhattan.png", height = 6, width = 12, units = "in", res = 300)
ggplot(collapsed_new_mismatches, aes(x=snv))+
  stat_count() +
  facet_grid(cols = vars(cat))
dev.off()

png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_snvs_cons_vs_specific_top100.png", height = 4, width = 6, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_snvs_cons_vs_specific_normalized_human_top100.png", height = 4, width = 8, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_snvs_cons_vs_specific_normalized_chimp_top100.png", height = 4, width = 8, units = "in", res = 300)
ggplot(m3, aes(x=Var1, y=Freq, group=cat)) +
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_width_indels_top100.png", height = 6, width = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_width_indels_by_manhattan_top100.png", height = 6, width = 4, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_width_indels_by_manhattan_norm_top_top100.png", height = 6, width = 2, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_width_indels_by_manhattan_norm_bottom_top100.png", height = 6, width = 2, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/location_mismatches.png", height = 4, width = 6, units = "in", res = 300)
...
save(pwm_insertion_h, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_AS_new_human_insertion_pwms_out.RData")
save(pwm_insertion_o, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_AS_new_chimp_insertion_pwms_out.RData")

```

```{r collapse output for insertions}
new_in_output_h <- list()
new_in_output_c <- list()
for (i in 1:length(pwm_insertion_h)){
  ...
  if (!is.null(do.call(rbind, pwm_insertion_o[[i]]))){
    new_in_output_c[[i]] <- do.call(rbind, pwm_insertion_o[[i]]) 
    current_name <- strsplit(as.character(new_in_output_c[[i]]$current_snp[1]), split = "\\_[0-9]+")
    names(new_in_output_c)[i] <- current_name
  }
}
...
new_new_in_output_c <- mapply(`[<-`, new_in_output_c, 'event_id', value = names(new_in_output_c), SIMPLIFY = FALSE)
...
collapsed_insertions_c <- do.call(rbind, new_new_in_output_c) %>% 
  na.omit() %>% 
  left_join(rnacmpt_ids, by = "current_motif") %>% 
  filter(Species == "Homo_sapiens") %>% 
  mutate(source = "chimp")
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_insertions_not_very_meaningful_overview.png", height = 5, width = 14, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_insertions_RBP_overview_by_dist_top100.png", height = 5, width = 20, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_insertions_RBP_overview_manhattan_dist_top100.png", height = 5, width = 15, units = "in", res = 300)
...
save(pwm_deletion_h, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_new_human_deletion_pwms_out.RData")
save(pwm_deletion_o, file = "~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS//SE_new_chimp_deletion_pwms_out.RData")
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_deletions_not_very_meaningful_overview.png", height = 5, width = 14, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_deletions_RBP_overview_by_dist_top100.png", height = 5, width = 20, units = "in", res = 300)
...
png("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/SE_deletions_RBP_overview_manhattan_dist_top100.png", height = 5, width = 15, units = "in", res = 300)
...
```{r save data}
save.image("~/Documents/05_results/01_primates/andrew_pipeline/remap_01_2020/cis_elements/human_chimp_SE_AS/human_chimp_SE_AS_variant_calling_data_SNP_level.RData")
